...
// in simulator we redefine to format for JoliJSSample Developer console
...
{\
	NSString * exceptionName = [@"org.jolijssample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.jolijssample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIJoliJSSampleNativeItemNone = -1, 
	UIJoliJSSampleNativeItemSpinner = -2,
	UIJoliJSSampleNativeItemProgressBar = -3,
	
	UIJoliJSSampleNativeItemSlider = -4,
	UIJoliJSSampleNativeItemSwitch = -5,
	UIJoliJSSampleNativeItemMultiButton = -6,
	UIJoliJSSampleNativeItemSegmented = -7,
	
	UIJoliJSSampleNativeItemTextView = -8,
	UIJoliJSSampleNativeItemTextField = -9,
	UIJoliJSSampleNativeItemSearchBar = -10,
	
	UIJoliJSSampleNativeItemPicker = -11,
	UIJoliJSSampleNativeItemDatePicker = -12,
	
	UIJoliJSSampleNativeItemInfoLight = -13,
	UIJoliJSSampleNativeItemInfoDark = -14,
	
	UIJoliJSSampleNativeItemDisclosure = -15,
	
	UIJoliJSSampleNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all JoliJSSample instances of
