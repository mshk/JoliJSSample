 ...
 * Copyright (c) 2009-2011 by JoliJSSample, Inc. All Rights Reserved.
...
//@interface JoliJSSampleObject : NSObject
//@end

@interface JoliJSSampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[JoliJSSampleObject class]])
		{
			for (NSString *key in [[(JoliJSSampleObject*)o modules] allKeys])
			{
