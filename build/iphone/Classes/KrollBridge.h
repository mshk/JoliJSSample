...
@interface JoliJSSampleObject : KrollCoverageObject {
#else
@interface JoliJSSampleObject : KrollObject {
#endif
@private
...
extern NSString * JoliJSSample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	JoliJSSampleObject *_jolijssample;
	BOOL shutdown;
